...
class ECPay_AllInOne {
    ...
    public $ServiceURL = 'https://payment-stage.ecpay.com.tw/Cashier/AioCheckOut/V5';
...
abstract class ECPay_Aio
{
   ...
   static function HtmlEncode($target = "_self", $arParameters= array(), $ServiceURL='', $szCheckMacValue= '', $paymentButton = '') {
