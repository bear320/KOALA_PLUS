        ...
        <nav class="game_nav">
            <div class="game_nav_money">
                <div class="game_nav_money_left">
                    ...
                    <p
                        class="game_money_1 game_money_2 game_money_3 game_money_4 game_money_5 game_money_6"
                    >
                        1,000
                    </p>
                </div>
            ...
            <div class="game_nav_bag_button btn-open" onclick="bag_talkwindow()">
